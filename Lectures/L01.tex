...
\begin{frame}
	...
	\small
	\begin{itemize}[<+-|alert@+>]
		\item 本课程作业由 \tcr{AI 批改}。
		\item 作业提交与批改：
		\begin{itemize}[<+-|alert@+>]
			\item 请关注微信公众号\tcr{「数你最灵」}；
			\item 作业提交、AI 批改和结果查看等全部操作均在\tcr{手机端}完成；
			\item 无需通过电子邮箱提交 PDF 或源文件。
		\end{itemize}
		\item 学生端完整使用手册已挂载至微信公众号\tcr{「数你最灵」}，首次使用前请仔细阅读，并按手册操作。
		\item 作业要求：解答不能仅有公式，必须写出必要的推理过程和文字说明。
		\item 每次作业的内容和截止时间以最新课程通知为准。
	\end{itemize}
...
\begin{frame}
	...
	\begin{itemize}[<+-|alert@+>]
		...
		\item 身心健康是最重要的：规律作息、适度运动，科学管理压力与情绪
		\item 找寻真正热爱的方向：长期专注坚持
		\item 深刻的思想远比机械的计算和技术性技能更重要：独立思考、批判性创新思维
		\item 道德品格：坚守正道，“有所为， 有所不为”，高道德标准，有原则，有底线

		\item 责任担当：拒做精致利己主义者，勇于承担责任，敢于面对挑战，改变社会
		%\item 终身学习：不断学习新知识，培养自我学习能力，学会独立思考和解决问题
		\end{itemize}
\item 微观层面：
		\begin{itemize}[<+-|alert@+>]
...
\begin{frame}
	\frametitle{几个问题}
	\begin{prob}
		假设概率论课程成绩是否及格对于你来说至关重要，不容有失， 现有两种不同的方式确定, 你选择哪一种?
		\begin{itemize}[<+-|alert@+>]
...
\begin{itemize}[<+-|alert@+>]
	...
	\item Cardano在第14章中明确定义了"比例", 若赌局中有利与不利数目比为：$a:b$，则赌局双方按$a:b$的比例下注才是公平的赌局.
\end{itemize}
\end{frame}
