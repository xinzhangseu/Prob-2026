...
\begin{frame}
	\frametitle{参考书目}
	\begin{itemize}[<+-|alert@+>]
		\item 概率论, 李增沪, 张梅, 何辉, 高等教育出版社, 2025
		\item 概率论, 张颢, 高等教育出版社, 2018
	    \item 概率论(第二版), 杨振明, 科学出版社, 2004
	    \item 概率论基础(第三版), 李贤平, 高等教育出版社, 2010
...
\begin{frame}
	\frametitle{成绩构成}
	\begin{itemize}[<+-|alert@+>]
		\item {\rm  \textcolor{cyan}{15\%}}: 考勤(不定时随机点名), \textcolor{red}{\bf 三次缺勤,此部分成绩为零, 但若期末考试成绩高于90分,则考勤成绩可用期末成绩替代.}
		\item {\rm  \textcolor{cyan}{20\%}} :平时成绩,含平时作业、大作业、讨论报告等.
		%\item  {\rm  \textcolor{cyan}{10\% - 15\%}} : 大作业、课堂讨论报告等
		\item  {\rm  \textcolor{cyan}{15\%}}  : 开卷测验.
...
\begin{frame}[fragile]
	...
	\begin{itemize}[<+-|alert@+>]
		\item 提交时间：每周四上课前
		\item 作业书写在A4纸上, 首行注明: 第$k$次作业:姓名-学号
