...
\begin{frame}
	\frametitle{成绩构成}
	\begin{itemize}[<+-|alert@+>]
		\item {\rm  \textcolor{cyan}{15\%}}: 考勤(不定时随机点名), \textcolor{red}{\bf 三次缺勤,此部分成绩为零, 但若期末考试成绩高于95分,则考勤成绩可用期末成绩替代.}
...
\begin{frame}
	...
	\begin{itemize}[<+-|alert@+>]
		...
		\item 课程{\rm QQ}群
		\begin{itemize}[<+-|alert@+>]
			\item 理科试验班：1012134052
			\item 强基拔尖班：856657190
			\end{itemize}
	\end{itemize}
\end{frame}
