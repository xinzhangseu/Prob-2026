...
\usepackage{xeCJK}    % CJK 包
 ...
 \setCJKmainfont[BoldFont=FandolHei-Regular.otf]{FandolKai-Regular.otf}
 \setCJKsansfont[BoldFont=FandolHei-Regular.otf]{FandolKai-Regular.otf}  % 设置中文字体
